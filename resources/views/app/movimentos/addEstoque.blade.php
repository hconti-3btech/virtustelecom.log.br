        ...
        <div class="col-12">
            <div class="container-fluid">
                ...
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('addEstoqueSave')}}" enctype="multipart/form-data" name = "forMovimento" id = "forMovimento" onsubmit="bloqSubmit()">
                            @csrf
                            <div id="campos">
                                <div class="input-group mb-3">
                                    ...
                                    <label class="custom-select rounded-0"> Entrada </label>
                                </div>
                                <div class="input-group mb-3">
                                    <div class="input-group-prepend">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12 col-sm-2 col-lg-3 mt-2">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Controle" id="controle0" name="controle[0]" value="{{ old('controle[0]') }}">                
                                        </div>
                                    </div>    
                                    <div class="col-12 col-sm-2 col-lg-3 mt-2">
                                        <div class="input-group mb-3">
                                            ...
                                            <input type="text" class="form-control" placeholder="Mac" id="mac0" name="mac[0]" value="{{ old('mac[0]') }}">                
                                        </div>
                                    </div>  
                                </div>
                            </div>
