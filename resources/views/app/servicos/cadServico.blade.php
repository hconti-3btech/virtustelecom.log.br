...
@section('content_header')
    <h1 class="m-0 text-dark">Cadastro de Serviço</h1>
@stop
        ...
        <div class="col-12">
            <div class="container-fluid">
                ...
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('cadServico')}}" enctype="multipart/form-data" onsubmit="bloqSubmit()">
                            @csrf                
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">Nome: </span>
                                </div>
                                <input id="descricao" type="text" class="form-control" placeholder="Nome do Servico" name="nome">
