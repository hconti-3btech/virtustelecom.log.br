        ...
        <div class="col-12">
            <div class="container-fluid">
                ...
                <div class="card card-info">
                    ...
                    <div class="card-body">
                        <form method="post" action="{{route('edtOrdem')}}" enctype="multipart/form-data" onsubmit="bloqSubmit()">
                            @csrf
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input id="ordem" type="text" class="form-control" placeholder="Numero da Ordem" name="ordem" value="{{ $ordem['ordem'] }}">
                            ...
                            <div class="input-group mb-3">
                                ...
                                <input id="cdc" type="text" class="form-control" placeholder="Numero do Contato do Cliente" name="cdc" value="{{ $ordem['cdc'] }}">
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                    <span class="input-group-text">Nome do Cliente: </span>
                                </div>
                                <input id="nome_cli" type="text" class="form-control" placeholder="Nome do Cliente" name="nome_cli" value="{{ $ordem['nome_cli'] }}">
                            </div>
                            <div class="input-group mb-3">
                                <div class="input-group-prepend">
                                ...
                                <select class="custom-select rounded-0" id="id_servico_tipo" name="id_servico_tipo">
                                    @foreach ( $servicos as $servico )
                                        <option value="{{$servico->id}}" {{ $ordem['id_servico_tipo'] === $servico->id ? 'selected' :''}}>{{$servico->nome}}</option>
                                    @endforeach
                                </select>
                                <div class="input-group-append">
                                    <span class="input-group-text"><i class="fas fa-solid fa-asterisk"></i></span>
                            ...
                            <div class="input-group mb-3">
                                ...
                                <select class="custom-select rounded-0" id="id_user_tec" name="id_user_tec">
                                    ...
                                    @foreach ( $usuarios as $usuario )
                                        <option value="{{$usuario->id}}" {{ $ordem['id_user_tec'] === $usuario->id ? 'selected' :''}}>{{$usuario->name}}</option>
                                    @endforeach
                                </select>
                            </div>
                            <div class="input-group mb-3">
